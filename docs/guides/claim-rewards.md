...
2. Wait for your submission to be accepted.
3. Wait for Pool to publish a claim epoch.
4. Look up the claim package by miner hotkey.
5. Submit the claim transaction.
6. The reward goes to the published recipient account.
