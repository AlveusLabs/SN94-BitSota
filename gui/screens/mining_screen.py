...
class MiningScreen(QWidget):
    """Main mining screen for direct and pool mining operations"""
    ...
    def setup_ui(self):
        ...
        content_layout.addWidget(self.mining_tab_switcher)
        ...
        # Stats and status panels container
        stats_status_container = QWidget()
        # stats_status_container.setMinimumHeight(310)
        ...
        content_layout.addWidget(stats_status_container)
        content_layout.addSpacing(24)
        
        # Logs section (auto-expand to fill remaining height)
        logs_section = self._create_logs_section()
        content_layout.addWidget(logs_section, 1)
        
        # Add content box to direct mining widget
        direct_layout.addWidget(content_box)
        
        # Pool mining widget (hidden by default)
    ...
    def _create_config_section(self) -> QWidget:
        ...
        self.task_type_map = {"Track 1": "cifar10_binary"}
    ...
    def _update_stats_labels(self, tasks: int, submissions: int, best_score: Optional[float]):
    ...
    def _on_mining_tab_changed(self, tab_id: str):
        ...
        if tab_id == "pool":
            ...
            self.mining_tab_switcher.set_active_tab("direct")
        else:
    ...
    def _create_status_indicator(self, text: str, dot_object_name: str, text_object_name: str):
    ...
    def _create_mining_status(self) -> QWidget:
        ...
        self.status_indicator_container, self.status_dot, self.mining_status_label = \
            self._create_status_indicator("Idle", "status_dot_idle", "status_text_idle")
        ...
        self.connection_indicator_container, self.connection_dot, self.connection_status_label = \
            self._create_status_indicator("Disconnected", "status_dot_disconnected", "status_text_disconnected")
    ...
    def update_connection_status(self, connected: bool):
        ...
        # Refresh styles
        for widget in [self.connection_status_label, self.connection_dot, 
                       self.mining_status_label, self.status_dot]:
